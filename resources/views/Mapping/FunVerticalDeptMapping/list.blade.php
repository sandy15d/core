@extends('layouts.app')
@push('breadcrumb')
    <li class="breadcrumb-item active">Fun Vertical Dept Mapping List</li>
@endpush
@push('page-back-button')
    <div class="page-back-button">
        <a href="{{ route('fun_vertical_dept_mappings.index')}}">
            <div class="icon">
                        ...
                        <tbody>
                            @foreach($list as $data)
                                <tr>
                                     ...
                                     <td>{{ $data->functionVertical->name }}</td>
