...
@endpush
@section('content')
    <div class="form-container content-width-full category-form-content js-ak-delete-container">
        <form method="POST" action="@isset($data->id){{route("category.update", $data->id)}}@else{{route("category.store")}}@endisset" enctype="multipart/form-data" class="form-page validate-form" novalidate>
            <div hidden>
             ...
             <div class="form-header">
                ...
                <div class="form-delete-record">
                    @if(isset($data->id))
                        <a href="#" data-link="{{route('category.destroy',$data->id)}}" data-id="{{$data->id}}" class="delete-link js-ak-delete-link" draggable="false">
        ...
        <div class="input-container">
            ...
            <div class="input-data">
                <input type="text" class="form-input " id="category_name" autocomplete="off"
                    name="category_name" placeholder="Category Name"
                    value="{{ old('category_name', $data->category_name ?? '') }}"   />
                <div class="error-message @if ($errors->has('category_name')) show @endif">
                    Required!</div>
                <div class="text-muted" id="category_name_help">
        ...
        <div class="input-container">
            ...
            <div class="input-data">
                <input type="text" class="form-input " id="category_code" autocomplete="off"
                    name="category_code" placeholder="Category Code"
                    value="{{ old('category_code', $data->category_code ?? '') }}"   />
                <div class="error-message @if ($errors->has('category_code')) show @endif">
                    Required!</div>
                <div class="text-muted" id="category_code_help">
        ...
        <div class="input-container">
            ...
            @includeIf("layouts.form_footer",["cancel_route"=>route("category.index")])
        </form>
