...
@endpush
@section('content')
    <div class="form-container content-width-full department-form-content js-ak-delete-container">
        <form method="POST" action="@isset($data->id){{route("department.update", $data->id)}}@else{{route("department.store")}}@endisset" enctype="multipart/form-data" class="form-page validate-form" novalidate>
            <div hidden>
             ...
             <div class="form-header">
                ...
                <div class="form-delete-record">
                    @if(isset($data->id))
                        <a href="#" data-link="{{route('department.destroy',$data->id)}}" data-id="{{$data->id}}" class="delete-link js-ak-delete-link" draggable="false">
        ...
        <div class="input-container">
            ...
            <div class="input-data">
                <input type="text" class="form-input " id="department_name" autocomplete="off"
                    name="department_name" placeholder="Department Name"
                    value="{{ old('department_name', $data->department_name ?? '') }}"   />
                <div class="error-message @if ($errors->has('department_name')) show @endif">
                    Required!</div>
                <div class="text-muted" id="department_name_help">
        ...
        <div class="input-container">
            ...
            <div class="input-data">
                <input type="text" class="form-input " id="department_code" autocomplete="off"
                    name="department_code" placeholder="Department Code"
                    value="{{ old('department_code', $data->department_code ?? '') }}"   />
                <div class="error-message @if ($errors->has('department_code')) show @endif">
                    Required!</div>
                <div class="text-muted" id="department_code_help">
        ...
        <div class="input-container">
            ...
            @includeIf("layouts.form_footer",["cancel_route"=>route("department.index")])
        </form>
