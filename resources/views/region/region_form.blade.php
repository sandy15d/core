...
@endpush
@section('content')
    <div class="form-container content-width-full region-form-content js-ak-delete-container">
        <form method="POST" action="@isset($data->id){{route("region.update", $data->id)}}@else{{route("region.store")}}@endisset" enctype="multipart/form-data" class="form-page validate-form" novalidate>
            <div hidden>
             ...
             <div class="form-header">
                ...
                <div class="form-delete-record">
                    @if(isset($data->id))
                        <a href="#" data-link="{{route('region.destroy',$data->id)}}" data-id="{{$data->id}}" class="delete-link js-ak-delete-link" draggable="false">
        ...
        <div class="input-container">
            ...
            <div class="input-data">
                <input type="text" class="form-input " id="region_name" autocomplete="off"
                    name="region_name" placeholder="Region Name"
                    value="{{ old('region_name', $data->region_name ?? '') }}"   />
                <div class="error-message @if ($errors->has('region_name')) show @endif">
                    Required!</div>
                <div class="text-muted" id="region_name_help">
        ...
        <div class="input-container">
            <div class="input-label">
                <label for="region_code">Region Code <span class="required">*</span></label>
            </div>
            <div class="input-data">
                <input type="text" class="form-input " id="region_code" autocomplete="off"
                    name="region_code" placeholder="Region Code"
                    value="{{ old('region_code', $data->region_code ?? '') }}"   />
                <div class="error-message @if ($errors->has('region_code')) show @endif">
                    Required!</div>
                <div class="text-muted" id="region_code_help">
        ...
        <div class="input-container">
            ...
            @includeIf("layouts.form_footer",["cancel_route"=>route("region.index")])
        </form>
