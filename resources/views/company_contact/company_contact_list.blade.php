                    ...
                    <div class="action">
                        <div class="left">
                            <form class="search-container">
                                ...
                                <input name="company_contact_length"
                                       value="{{Request()->query("company_contact_length")}}" type="hidden"/>
                                <div class="search">
                                    <input type="text" autocomplete="off" placeholder="Search"
                                           name="company_contact_search"
                ...
                <div class="content table-content">
                    <table class="table js-ak-content">
                        ...
                        <tr data-sort-method='thead'>
                            ...
                            <th>Designation</th>
                            <th>Contact No. One</th>
                            <th>Contact No. Two</th>
                            <th>Is Active</th>
