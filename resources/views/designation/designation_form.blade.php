...
@endpush
@section('content')
    <div class="form-container content-width-full designation-form-content js-ak-delete-container">
        <form method="POST" action="@isset($data->id){{route("designation.update", $data->id)}}@else{{route("designation.store")}}@endisset" enctype="multipart/form-data" class="form-page validate-form" novalidate>
            <div hidden>
             ...
             <div class="form-header">
                ...
                <div class="form-delete-record">
                    @if(isset($data->id))
                        <a href="#" data-link="{{route('designation.destroy',$data->id)}}" data-id="{{$data->id}}" class="delete-link js-ak-delete-link" draggable="false">
        ...
        <div class="input-container">
            ...
            <div class="input-data">
                <input type="text" class="form-input " id="designation_name" autocomplete="off"
                    name="designation_name" placeholder="Designation Name"
                    value="{{ old('designation_name', $data->designation_name ?? '') }}"   />
                <div class="error-message @if ($errors->has('designation_name')) show @endif">
                    Required!</div>
                <div class="text-muted" id="designation_name_help">
        ...
        <div class="input-container">
            <div class="input-label">
                <label for="designation_code">Designation Code <span class="required">*</span></label>
            </div>
            <div class="input-data">
                <input type="text" class="form-input " id="designation_code" autocomplete="off"
                    name="designation_code" placeholder="Designation Code"
                    value="{{ old('designation_code', $data->designation_code ?? '') }}"   />
                <div class="error-message @if ($errors->has('designation_code')) show @endif">
                    Required!</div>
                <div class="text-muted" id="designation_code_help">
        ...
        <div class="input-container">
            ...
            @includeIf("layouts.form_footer",["cancel_route"=>route("designation.index")])
        </form>
