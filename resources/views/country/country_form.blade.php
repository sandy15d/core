        ...
        <div class="input-container">
            ...
            <div class="input-data">
                <select name="global_region" id="global_region" class="form-select">
                    <option value="">Select Global Region</option>@foreach ($global_region_list as $list)
                                        <option value="{{$list->id}}" {{ $data->global_region == $list->id ? "selected" : "" }}>{{ $list->global_region_name }}</option>
                                     @endforeach
                </select>
