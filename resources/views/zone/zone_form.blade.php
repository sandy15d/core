...
@endpush
@section('content')
    <div class="form-container content-width-full zone-form-content js-ak-delete-container">
        <form method="POST" action="@isset($data->id){{route("zone.update", $data->id)}}@else{{route("zone.store")}}@endisset" enctype="multipart/form-data" class="form-page validate-form" novalidate>
            <div hidden>
             ...
             <div class="form-header">
                ...
                <div class="form-delete-record">
                    @if(isset($data->id))
                        <a href="#" data-link="{{route('zone.destroy',$data->id)}}" data-id="{{$data->id}}" class="delete-link js-ak-delete-link" draggable="false">
        ...
        <div class="input-container">
            ...
            <div class="input-data">
                <input type="text" class="form-input " id="zone_name" autocomplete="off"
                    name="zone_name" placeholder="Zone Name"
                    value="{{ old('zone_name', $data->zone_name ?? '') }}"   />
                <div class="error-message @if ($errors->has('zone_name')) show @endif">
                    Required!</div>
                <div class="text-muted" id="zone_name_help">
        ...
        <div class="input-container">
            <div class="input-label">
                <label for="zone_code">Zone Code <span class="required">*</span></label>
            </div>
            <div class="input-data">
                <input type="text" class="form-input " id="zone_code" autocomplete="off"
                    name="zone_code" placeholder="Zone Code"
                    value="{{ old('zone_code', $data->zone_code ?? '') }}"   />
                <div class="error-message @if ($errors->has('zone_code')) show @endif">
                    Required!</div>
                <div class="text-muted" id="zone_code_help">
        ...
        <div class="input-container">
            ...
            @includeIf("layouts.form_footer",["cancel_route"=>route("zone.index")])
        </form>
