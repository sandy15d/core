...
@push('breadcrumb')
    ...
    <li class="breadcrumb-item active"> Pack Size</li>
@endpush

@push('page-back-button')
    <div class="page-back-button">
        <a href="{{ route("pack_size.index") }}">
            <div class="icon">
...
@endpush
@section('content')
    <div class="form-container content-width-full pack_size-form-content js-ak-delete-container">
        <form method="POST" action="@isset($data->id){{route("pack_size.update", $data->id)}}@else{{route("pack_size.store")}}@endisset" enctype="multipart/form-data" class="form-page validate-form" novalidate>
            <div hidden>
             ...
             <div class="form-header">
                ...
                <div class="form-delete-record">
                    @if(isset($data->id))
                        <a href="#" data-link="{{route('pack_size.destroy',$data->id)}}" data-id="{{$data->id}}" class="delete-link js-ak-delete-link" draggable="false">
        ...
        <div class="input-container">
            ...
            <div class="input-data">
                <input type="text" class="form-input " id="pack_size" autocomplete="off"
                    name="pack_size" placeholder="Pack Size"
                    value="{{ old('pack_size', $data->pack_size ?? '') }}"   />
                <div class="error-message @if ($errors->has('pack_size')) show @endif">
                    Required!</div>
                <div class="text-muted" id="pack_size_help">
        ...
        <div class="input-container">
            <div class="input-label">
                <label for="pack_size_code">Pack Size Code <span class="required">*</span></label>
            </div>
            <div class="input-data">
                <input type="number" class="form-input " id="pack_size_code" autocomplete="off"
                    name="pack_size_code" placeholder="Pack Size Code"
                    value="{{ old('pack_size_code', $data->pack_size_code ?? '') }}"   />
                <div class="error-message @if ($errors->has('pack_size_code')) show @endif">
                    Required!</div>
                <div class="text-muted" id="pack_size_code_help">
        ...
        <div class="input-container">
            ...
            @includeIf("layouts.form_footer",["cancel_route"=>route("pack_size.index")])
        </form>
