...
@endpush
@section('content')
    <div class="form-container content-width-full crop-form-content js-ak-delete-container">
        <form method="POST" action="@isset($data->id){{route("crop.update", $data->id)}}@else{{route("crop.store")}}@endisset" enctype="multipart/form-data" class="form-page validate-form" novalidate>
            <div hidden>
             ...
             <div class="form-header">
                ...
                <div class="form-delete-record">
                    @if(isset($data->id))
                        <a href="#" data-link="{{route('crop.destroy',$data->id)}}" data-id="{{$data->id}}" class="delete-link js-ak-delete-link" draggable="false">
        ...
        <div class="input-container">
            ...
            <div class="input-data">
                <select name="vertical_id" id="vertical_id" class="form-select">
                    <option value="">Select Vertical</option>@foreach ($vertical_list as $list)
        ...
        <div class="input-container">
            ...
            <div class="input-data">
                <input type="text" class="form-input " id="crop_name" autocomplete="off"
                    name="crop_name" placeholder="Crop Name"
                    value="{{ old('crop_name', $data->crop_name ?? '') }}"   />
                <div class="error-message @if ($errors->has('crop_name')) show @endif">
                    Required!</div>
                <div class="text-muted" id="crop_name_help">
        ...
        <div class="input-container">
            <div class="input-label">
                <label for="crop_code">Crop Code </label>
            </div>
            <div class="input-data">
                <input type="text" class="form-input " id="crop_code" autocomplete="off"
                    name="crop_code" placeholder="Crop Code"
                    value="{{ old('crop_code', $data->crop_code ?? '') }}"   />
                <div class="error-message @if ($errors->has('crop_code')) show @endif">
                    Required!</div>
                <div class="text-muted" id="crop_code_help">
        ...
        <div class="input-container">
            ...
            @includeIf("layouts.form_footer",["cancel_route"=>route("crop.index")])
        </form>
