...
@push('page-back-button')
    <div class="page-back-button">
        <a href="{{ route("org_function.index") }}">
            <div class="icon">
...
@endpush
@section('content')
    <div class="form-container content-width-full org_function-form-content js-ak-delete-container">
        <form method="POST" action="@isset($data->id){{route("org_function.update", $data->id)}}@else{{route("org_function.store")}}@endisset" enctype="multipart/form-data" class="form-page validate-form" novalidate>
            <div hidden>
             ...
             <div class="form-header">
                ...
                <div class="form-delete-record">
                    @if(isset($data->id))
                        <a href="#" data-link="{{route('org_function.destroy',$data->id)}}" data-id="{{$data->id}}" class="delete-link js-ak-delete-link" draggable="false">
        ...
        <div class="input-container">
            <div class="input-label">
                <label for="function_name">Function Name <span class="required">*</span></label>
            </div>
            <div class="input-data">
                <input type="text" class="form-input " id="function_name" autocomplete="off"
                    name="function_name" placeholder="Function Name"
                    value="{{ old('function_name', $data->function_name ?? '') }}"   />
                <div class="error-message @if ($errors->has('function_name')) show @endif">
                    Required!</div>
                <div class="text-muted" id="function_name_help">
        ...
        <div class="input-container">
            <div class="input-label">
                <label for="function_code">Function Code <span class="required">*</span></label>
            </div>
            <div class="input-data">
                <input type="text" class="form-input " id="function_code" autocomplete="off"
                    name="function_code" placeholder="Function Code"
                    value="{{ old('function_code', $data->function_code ?? '') }}"   />
                <div class="error-message @if ($errors->has('function_code')) show @endif">
                    Required!</div>
                <div class="text-muted" id="function_code_help">
        ...
        <div class="input-container">
            ...
            @includeIf("layouts.form_footer",["cancel_route"=>route("org_function.index")])
        </form>
