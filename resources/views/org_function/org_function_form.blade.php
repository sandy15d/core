...
@section('content')
    <div class="form-container content-width-full org_function-form-content js-ak-delete-container">
        <form method="POST"
              action="@isset($data->id){{route("org_function.update", $data->id)}}@else{{route("org_function.store")}}@endisset"
            ...
            <div class="form-header">
                ...
                @can('delete-OrgFunction')
                    <div class="form-delete-record">
                        @if(isset($data->id))
                            <a href="#" data-link="{{route('org_function.destroy',$data->id)}}" data-id="{{$data->id}}"
                        ...
                        <div class="input-data">
                            <div class="group-input date-time-group" id="ak_date_group_effective_date">
                                <input type="text" name="effective_date"
                                       ...
                                       value="{{ old('effective_date', isset($data->effective_date)?$data->getRawOriginal('effective_date') : '') }}">
