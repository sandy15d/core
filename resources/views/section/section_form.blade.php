...
@endpush
@section('content')
    <div class="form-container content-width-full section-form-content js-ak-delete-container">
        <form method="POST" action="@isset($data->id){{route("section.update", $data->id)}}@else{{route("section.store")}}@endisset" enctype="multipart/form-data" class="form-page validate-form" novalidate>
            <div hidden>
             ...
             <div class="form-header">
                ...
                <div class="form-delete-record">
                    @if(isset($data->id))
                        <a href="#" data-link="{{route('section.destroy',$data->id)}}" data-id="{{$data->id}}" class="delete-link js-ak-delete-link" draggable="false">
        ...
        <div class="input-container">
            ...
            <div class="input-data">
                <input type="text" class="form-input " id="section_name" autocomplete="off"
                    name="section_name" placeholder="Section Name"
                    value="{{ old('section_name', $data->section_name ?? '') }}"   />
                <div class="error-message @if ($errors->has('section_name')) show @endif">
                    Required!</div>
                <div class="text-muted" id="section_name_help">
        ...
        <div class="input-container">
            ...
            <div class="input-data">
                <input type="text" class="form-input " id="section_code" autocomplete="off"
                    name="section_code" placeholder="Section Code"
                    value="{{ old('section_code', $data->section_code ?? '') }}"   />
                <div class="error-message @if ($errors->has('section_code')) show @endif">
                    Required!</div>
                <div class="text-muted" id="section_code_help">
        ...
        <div class="input-container">
            ...
            @includeIf("layouts.form_footer",["cancel_route"=>route("section.index")])
        </form>
