                        ...
                        <div class="action">
                            <div class="left">
                                <form class="search-container">
                                    ...
                                    <input name="company_address_length" value="{{Request()->query("company_address_length")}}" type="hidden"/>
                                    <div class="search">
                                        <input type="text" autocomplete="off" placeholder="Search" name="company_address_search"
                        ...
                        <table class="table js-ak-content">
                            ...
                            <tr data-sort-method='thead'>
                                <th class="table-id" data-sort-method="number">ID</th>
                                   <th>Company</th>   <th>Address Type</th>   <th>Address</th>   <th>Country</th>   <th>State</th>   <th>District</th>   <th>City</th>   <th>Pin Code</th>
